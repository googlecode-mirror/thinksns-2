...
class NotifyService extends Service{
	...
	private function _parseTemplate($i_data){
		...
		$replace["{actor}"] = '<a href="'.U("home/space/index",array("uid"=>$i_data['from'])).'" target="_blank">'.getUserName($i_data['from']).'</a>'.getUserGroupIcon($i_data['from']);
