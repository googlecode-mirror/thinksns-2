...
$i_message['install_lock'] = '您已安装过ThinkSNS 2.0 build 7775，如果需要重新安装，请先删除install目录下的install.lock文件';
$i_message['install_title'] = 'ThinkSNS 2.0 build 7775 安装向导';
