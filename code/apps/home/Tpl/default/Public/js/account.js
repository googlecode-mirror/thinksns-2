function changeEduCar(o){
	...
	var educationHtml = '<li><DIV class="left alR" style="width:15%;">学校名称：</DIV>'
					  + '<DIV class="left cGray2" style="width:85%;"><input name="school" type="text" class="text" id="textfield12" style="width:200px;" onBlur="this.className=\'text\'" onFocus="this.className=\'text2\'" dataType="LimitB" min="1" max="300" msg="学校名称不能为空!" /></DIV>'
					  + '<DIV class="left cGray2"></DIV></li>'
					  + '<li><DIV class="left alR" style="width:15%;">班级或院系：</DIV>'
					  + '<DIV class="left" style="width: 85%;"><input name="classes" type="text" class="text" id="textfield13" style="width:200px;" onBlur="this.className=\'text\'" onFocus="this.className=\'text2\'" dataType="LimitB" min="1" max="300" msg="班级名称不能为空!" />'
					  + '</DIV></li>'
	...
	var careerHtml    = '<li><DIV class="left alR lh25" style="width:15%;">公司/机构：</DIV>'
                      ...
                      + '<select style="width: 4.5em;" name="beginyear" id="beginyear" dataType="Require"  msg="未选择入职年份">' + getYearList() + '</select>年 '
                      + '<select style="width: 3.5em;" id="beginmonth" name="beginmonth">' + getMonthList() + '</select>至'
                      + '<select style="width: 4.5em;" id="endyear" name="endyear">' + getYearList() + '</select><span id="endyearword">年</span> '
